...
\begin{itemize}
	...
	\item Comparison (\verb|==|,\verb|<|,\verb|>|,\verb|<=|,\verb|>=|,\verb|!=|) - These operators are used for comparisons. They give back a truth value to help determine which route to take in a conditional operation/decision. For example, \ver|x>0| will be true if the value of \verb|x| is larger than 0 and false otherwise.

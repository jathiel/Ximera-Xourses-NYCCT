...
==============================
\end{verbatim}
		\item Mathematical functions like $e^x$, $\sin(x)$ have to be imported from another file. Use this \link[linksd]{https://docs.python.org/2/library/math.html} for more information.
\begin{verbatim}
==============================
import math

...
\begin{question}
	Use the Bisection Method to give an approximation of all of the solutions to $\ln{x}+\sin{x}=2$ on the interval $[5,20]$.
\end{question}

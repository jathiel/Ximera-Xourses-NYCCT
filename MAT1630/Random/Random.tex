...
In order to run a Monte Carlo simulation, we are going to have to generate random numbers somehow. The NumPy library can help us with this. (For a list of available functions related to random sampling, see this \link[link]{https://numpy.org/doc/stable/search.html?q=Random\%20sampling\%20(numpy.random)}.)

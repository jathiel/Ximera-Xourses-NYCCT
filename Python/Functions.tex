...
\begin{question}
	...
	\begin{hint}
	Consider having three inputs for this function, \verb|a|, \verb|b|, and \verb|c|. Note that the second hint for this problem is the solution.
	\end{hint}
	\begin{hint}
\begin{sageCell}

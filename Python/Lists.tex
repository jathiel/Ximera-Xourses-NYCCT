...
Note that \verb|b=a| does not create a new list \verb|b| with the same elements as \verb|a|. Rather, both are references to the same object. To create a duplicate copy of a list that avoids this issue, use \verb|b = a[:]|.

...
\begin{itemize}
	...
	\item The `if', `then', `else', etc. represent the individual steps taken in the algorithm. (For a more complete treatment of this, see Rosen's Discrete Mathematics and Its Applications textbook.)
